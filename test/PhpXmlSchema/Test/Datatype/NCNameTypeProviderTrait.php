...
/**
 * Represents a trait that provides datasets to unit test "NCName" datatype.
 * 
 * @author  Christophe Maymard  <christophe.maymard@hotmail.com>
 */
trait NCNameTypeProviderTrait
{
    /**
    ...
    /**
     * Returns a set of valid NCName datatype values (with white space 
     * processing).
     * 
     * @return  array[]
     */
    ...
    public function getInvalidNCNameTypeValues(): array
    {
        ...
        foreach (self::getValidDigitChars() as $name => $char) {
    ...
    /**
     * Returns a set of invalid NCName datatype values (with white space 
     * processing).
     * 
     * @return  array[]
     */
