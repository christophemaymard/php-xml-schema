...
/**
 * Represents the integration tests for the {@see PhpXmlSchema\Dom\SimpleContentExtensionElement} class.
 * 
 * @group   element
 * @group   dom
 * 
 ...
 */
class SimpleContentExtensionElementTest extends AbstractAbstractElementTestCase
{
    /**
     * {@inheritDoc}
     */
     ...
     * @group   content
     */
    public function testSimpleContentExtensionElementWhenAddedToSimpleContentElement(): void
    {
     ...
     * @group   content
     */
    public function testSimpleContentExtensionElementWithParentThrowsExceptionWhenSimpleContentElementSetDerivationElement(): void
    {
