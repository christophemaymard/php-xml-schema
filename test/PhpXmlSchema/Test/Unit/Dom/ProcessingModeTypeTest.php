...
class ProcessingModeTypeTest extends TestCase
{
     ...
     */
    private static function assertProcessingModeLax(ProcessingModeType $sut)
    {
     ...
     * @param   ProcessingModeType  $sut
     */
    private static function assertProcessingModeSkip(ProcessingModeType $sut)
    {
     ...
     * @param   ProcessingModeType  $sut
     */
    private static function assertProcessingModeStrict(ProcessingModeType $sut)
    {
     ...
     */
    public function testIsLaxReturnsTrueWhenModeLax()
    {
     ...
     */
    public function testIsSkipReturnsTrueWhenModeSkip()
    {
     ...
     */
    public function testIsStrictReturnsTrueWhenModeStrict()
    {
     ...
     * is invalid.
     */
    public function test__constructThrowsExceptionWhenModeIsInvalid()
    {
     ...
     */
    public function testCreateLaxReturnsInstanceModeLax()
    {
     ...
     */
    public function testCreateLaxReturnsNewInstance()
    {
     ...
     */
    public function testCreateSkipReturnsInstanceModeSkip()
    {
     ...
     */
    public function testCreateSkipReturnsNewInstance()
    {
     ...
     */
    public function testCreateStrictReturnsInstanceModeStrict()
    {
     ...
     */
    public function testCreateStrictReturnsNewInstance()
    {
