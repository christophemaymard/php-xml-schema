 ...
 */
abstract class AbstractAttributeGroupSchemaElementBuilderTestCase extends AbstractSchemaElementBuilderTestCase
{
    ...
    public static function assertSchemaElementNotChanged(SchemaElement $sch)
    {
        ...
        $ag = static::getCurrentElement($sch);
     ...
     * element is the "attributeGroup" element and the value is valid.
     * 
     ...
     * element is the "attributeGroup" element and the value is invalid.
     * 
     * @param   string  $value  The value to test.
     ...
     * current element is the "attributeGroup" element.
     * 
     * @group   content
     * @group   element
     */
