 ...
 * class when the current element is the "maxExclusive" element.
 * 
 * @group   element
 * @group   dom
 * 
...
class MaxExclusiveSchemaElementBuilderTest extends AbstractSchemaElementBuilderTestCase
{
    ...
    public static function assertAncestorsNotChanged(SchemaElement $sch): void
    {
        ...
        self::assertCount(1, $res->getMaxExclusiveElements());
    }
    ...
    {
        self::assertMaxExclusiveElementHasNoAttribute(self::getCurrentElement($sch));
    }
     ...
     * current element is the "maxExclusive" element and the value is valid.
     * 
     ...
     */
    public function testBuildFixedAttributeCreatesAttrWhenMaxExclusiveAndValueIsValid(
        string $value, 
        bool $bool
    ): void
    {
     ...
     */
    public function testBuildFixedAttributeThrowsExceptionWhenMaxExclusiveAndValueIsInvalid(
        string $value
    ): void
    {
     ...
     * element is the "maxExclusive" element and the value is valid.
     * 
     * @param   string  $value  The value to test.
     ...
     * @group   parsing
     */
    public function testBuildValueAttributeCreatesAttrWhenMaxExclusiveAndValueIsValid(): void
    {
     ...
     * @group   element
     */
    public function testBuildAnnotationElementCreateEltWhenMaxExclusive(): void
    {
