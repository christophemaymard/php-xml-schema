...
class LocalComplexTypeSchemaElementBuilderTest extends AbstractSchemaElementBuilderTestCase
{
     ...
     * @group   element
     */
    public function testBuildAttributeElementCreateEltWhenLocalComplexType()
    {
     ...
     * @group   element
     */
    public function testBuildAttributeGroupElementCreateEltWhenLocalComplexType()
    {
     ...
     * @group   element
     */
    public function testBuildAnyAttributeElementCreateEltWhenLocalComplexType()
    {
