...
class SimpleChoiceSchemaElementBuilderTest extends AbstractSchemaElementBuilderTestCase
{
     ...
     * @group   element
     */
    public function testBuildElementElementCreateEltWhenSimpleChoice()
    {
     ...
     * @group   element
     */
    public function testBuildGroupElementCreateEltWhenSimpleChoice()
    {
        $this->sut->buildGroupElement();
        $this->sut->endElement();
        $this->sut->buildGroupElement();
     ...
     * @group   element
     */
    public function testBuildChoiceElementCreateEltWhenSimpleChoice()
    {
        $this->sut->buildChoiceElement();
        $this->sut->endElement();
        $this->sut->buildChoiceElement();
     ...
     * @group   element
     */
    public function testBuildSequenceElementCreateEltWhenSimpleChoice()
    {
