...
use PhpXmlSchema\Test\Dom\FieldXPathTypeProviderTrait;

/**
 * Represents the unit tests for the {@see PhpXmlSchema\Dom\SchemaElementBuilder} 
 * class when the current element is the "field" element.
 * 
 * @group   element
 * @group   dom
 * 
...
class FieldSchemaElementBuilderTest extends AbstractSchemaElementBuilderTestCase
{
    ...
    public static function assertAncestorsNotChanged(SchemaElement $sch): void
    {
        ...
        self::assertCount(1, $unique->getFieldElements());
    }
    ...
    ): void
    {
        ...
        self::assertFieldElementHasOnlyIdAttribute($sel);
