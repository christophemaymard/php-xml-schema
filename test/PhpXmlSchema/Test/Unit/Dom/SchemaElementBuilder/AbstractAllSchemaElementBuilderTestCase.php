 ...
 * class when the current element is the "all" element.
 * 
 * @group   element
 * @group   dom
 * 
 ...
 */
abstract class AbstractAllSchemaElementBuilderTestCase extends AbstractSchemaElementBuilderTestCase
{
     ...
     * element is the "all" element and the value is valid.
     * 
     ...
     * element is the "all" element and the value is invalid.
     * 
     * @param   string  $value  The value to test.
     ...
     * current element is the "all" element.
     * 
     * @group   content
     * @group   element
     */
