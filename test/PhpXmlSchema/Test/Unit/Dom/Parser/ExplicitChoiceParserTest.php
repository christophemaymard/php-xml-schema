 ...
 * when the context is {@see PhpXmlSchema\Dom\ContextId::ELT_EXPLICIT_CHOICE}.
 * 
 * @group   parsing
 * @group   dom
 * 
 ...
 */
class ExplicitChoiceParserTest extends AbstractParserTestCase
{
    ...
    {
        $sch = $this->sut->parse($this->getXs('choice_maxOccurs_0001.xsd'));
    ...
    public function getValidMinOccursAttributes():array
    {
        return [
            '0' => [
                'choice_minOccurs_0001.xsd', 
                \gmp_init(0), 
            ], 
            '0 with positive sign' => [
                'choice_minOccurs_0002.xsd', 
                \gmp_init(0), 
            ], 
            '0 with positive sign and leading zeroes' => [
                'choice_minOccurs_0003.xsd', 
                \gmp_init(0), 
            ], 
            '0 with positive sign, leading zeroes and surrounded by white spaces' => [
                'choice_minOccurs_0004.xsd', 
                \gmp_init(0), 
            ], 
            '1234567890' => [
                'choice_minOccurs_0005.xsd', 
                \gmp_init(1234567890), 
            ], 
            '1234567890 with positive sign' => [
                'choice_minOccurs_0006.xsd', 
                \gmp_init(1234567890), 
            ], 
            '1234567890 with positive sign and leading zeroes' => [
                'choice_minOccurs_0007.xsd', 
                \gmp_init(1234567890), 
            ], 
            '1234567890 with positive sign, leading zeroes and surrounded by white spaces' => [
                'choice_minOccurs_0008.xsd', 
                \gmp_init(1234567890), 
            ], 
        ];
    }
