...
class KeyRefParserTest extends AbstractParserTestCase
{
    ...
    /**
     * Tests that parse() processes "refer" attribute when the prefix is 
     ...
     * 
     * @group           attribute
     * @dataProvider    getValidNoNamespaceReferAttributes
     */
    ...
    /**
     * Tests that parse() processes "refer" attribute.
     * 
     * @param   string      $fileName   The name of the file used for the test.
     ...
     * 
     * @group           attribute
     * @dataProvider    getValidReferAttributes
     */
    public function testParseProcessReferAttribute(
        string $fileName, 
        array $decls, 
        string $namespace, 
        string $localPart
    ): void
    {
        ...
        self::assertElementNamespaceDeclarations([], $keyRef);
        self::assertKeyRefElementHasOnlyReferAttribute($keyRef);
        self::assertSame($namespace, $keyRef->getRefer()->getNamespace()->getAnyUri());
        self::assertSame($localPart, $keyRef->getRefer()->getLocalPart()->getNCName());
        self::assertCount(2, $keyRef->getElements());
    ...
    /**
     * Returns a set of valid "refer" attributes with no prefix and no 
     * default namespace.
     * 
     * @return  array[]
     */
    public function getValidNoNamespaceReferAttributes(): array
    {
        return [
            'Local part starts with _' => [
                'keyref_refer_0001.xsd', 
                '_foo', 
            ], 
            'Local part starts with letter' => [
                'keyref_refer_0002.xsd', 
                'f', 
            ], 
            'Local part contains letter' => [
                'keyref_refer_0003.xsd', 
                'foo', 
            ], 
            'Local part contains digit' => [
                'keyref_refer_0004.xsd', 
                'f00', 
            ], 
            'Local part contains .' => [
                'keyref_refer_0005.xsd', 
                'f.bar', 
            ], 
            'Local part contains -' => [
                'keyref_refer_0006.xsd', 
                'f-bar', 
            ], 
            'Local part contains _' => [
                'keyref_refer_0007.xsd', 
                'f_bar', 
            ], 
            'Local part surrounded by white spaces' => [
                'keyref_refer_0008.xsd', 
                'foo_bar', 
            ], 
        ];
    }
    ...
    /**
     * Returns a set of valid "refer" attributes.
     * 
     * @return  array[]
     */
