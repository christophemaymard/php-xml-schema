 ...
 * when the context is {@see PhpXmlSchema\Dom\ContextId::ELT_UNIQUE}.
 * 
 * @group   parsing
 * @group   dom
 * 
 ...
 */
class UniqueParserTest extends AbstractParserTestCase
{
    ...
    public function testParseProcessFieldElement()
    {
        ...
        self::assertElementNamespaceDeclarations([], $unique);
        self::assertUniqueElementHasNoAttribute($unique);
        self::assertCount(3, $unique->getElements());
    ...
    public function getValidIdAttributes():array
    {
        return [
            'Starts with _' => [
                'unique_id_0001.xsd', '_foo', 
            ], 
            'Starts with letter' => [
                'unique_id_0002.xsd', 'f', 
            ], 
            'Contains letter' => [
                'unique_id_0003.xsd', 'foo', 
            ], 
            'Contains digit' => [
                'unique_id_0004.xsd', 'f00', 
            ], 
            'Contains .' => [
                'unique_id_0005.xsd', 'f.bar', 
            ], 
            'Contains -' => [
                'unique_id_0006.xsd', 'f-bar', 
            ], 
            'Contains _' => [
                'unique_id_0007.xsd', 'f_bar', 
            ], 
            'Surrounded by whitespaces' => [
                'unique_id_0008.xsd', 'foo_bar', 
            ], 
        ];
    }
    ...
    public function getValidNameAttributes():array
    {
        return [
            'Starts with _' => [
                'unique_name_0001.xsd', '_foo', 
            ], 
            'Starts with letter' => [
                'unique_name_0002.xsd', 'f', 
            ], 
            'Contains letter' => [
                'unique_name_0003.xsd', 'foo', 
            ], 
            'Contains digit' => [
                'unique_name_0004.xsd', 'f00', 
            ], 
            'Contains .' => [
                'unique_name_0005.xsd', 'f.bar', 
            ], 
            'Contains -' => [
                'unique_name_0006.xsd', 'f-bar', 
            ], 
            'Contains _' => [
                'unique_name_0007.xsd', 'f_bar', 
            ], 
            'Surrounded by whitespaces' => [
                'unique_name_0008.xsd', 'foo_bar', 
            ], 
        ];
    }
}
