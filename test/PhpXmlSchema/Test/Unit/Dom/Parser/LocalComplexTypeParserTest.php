 ...
 * when the context is {@see PhpXmlSchema\Dom\ContextId::ELT_LOCAL_COMPLEXTYPE}.
 * 
 * @group   parsing
 * @group   dom
 * 
 ...
 */
class LocalComplexTypeParserTest extends AbstractParserTestCase
{
    ...
    public function testParseProcessMixedAttribute(string $fileName, bool $bool): void
    {
        ...
        $ct2 = $elt->getTypeElement();
        self::assertElementNamespaceDeclarations([], $ct2);
        self::assertComplexTypeElementHasOnlyMixedAttribute($ct2);
        self::assertSame($bool, $ct2->getMixed());
        self::assertSame([], $ct2->getElements());
    }
     ...
     * @group   element
     */
    public function testParseProcessSimpleContentElement(): void
    {
     ...
     * @group   element
     */
    public function testParseProcessComplexContentElement(): void
    {
        ...
        $cc1 = $ct1->getContentElement();
        self::assertElementNamespaceDeclarations([], $cc1);
    ...
    public function testParseProcessGroupElement(): void
    {
        ...
        $grp = $ct2->getTypeDefinitionParticleElement();
    ...
    public function testParseProcessSequenceElement(): void
    {
        ...
        $seq = $ct2->getTypeDefinitionParticleElement();
    ...
    public function testParseProcessAttributeElement(): void
    {
        ...
        self::assertElementNamespaceDeclarations([], $ct2);
        self::assertComplexTypeElementHasNoAttribute($ct2);
        self::assertCount(2, $ct2->getElements());
        
        $attrs = $ct2->getAttributeElements();
    ...
    public function testParseProcessAttributeGroupElement(): void
    {
        ...
        $ags = $ct2->getAttributeGroupElements();
    ...
    public function testParseProcessAnyAttributeElement(): void
    {
        ...
        $anyAttr = $ct2->getAnyAttributeElement();
