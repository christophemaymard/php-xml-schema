 ...
 */
class ComplexContentExtensionElementTest extends AbstractCompositeElementTestCase
{
    /**
     * {@inheritDoc}
     */
     ...
     * - elements from container 1 ((group | all | choice | sequence)?)
     * - elements from container 2 ((attribute | attributeGroup)*)
     * - elements from container 3 (anyAttribute?)
     * 
     * @group   elt-content
     */
    public function testGetElementsReturnsElementsOrderedByContainer0123()
    {
        $children = [];
        $children[] = $this->createAnnotationElementDummy();
        $children[] = $this->createTypeDefinitionParticleElementInterfaceDummy();
        ...
        self::assertSame($children, $this->sut->getElements(), 'Elements ordered by container: 0, 1, 2, 3.');
    }
